...
export default class Torch extends Sender {
	public static imagePath = "/img/torch.png";

	constructor(x: number, y: number, degrees: number) {
		degrees = normalizeDegrees(degrees);
		const rect = Rectangle.fromTopLeftAndSize(new Point(x, y), 200, 100, degrees);
		...
		super(rect, "/img/torch.png", lasers);
	}
...
export const isTorch = (object: any): object is Torch => {
	return object instanceof Torch;
};
