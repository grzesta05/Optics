...
export default class Bulb extends Sender {
	public static imagePath = "/img/bulb.png";

	constructor(x: number, y: number, degrees: number) {
		degrees = normalizeDegrees(degrees);
		const rect = Rectangle.fromTopLeftAndSize(new Point(x, y), 100, 150, degrees);
		...
		super(rect, "/img/bulb.png", lasers);
	}
...
export const isBulb = (object: any): object is Bulb => {
	return object instanceof Bulb;
};
